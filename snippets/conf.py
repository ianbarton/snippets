...
BLOG_TITLE = "My Code Snippets"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://snippets.ianbarton.net/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://snippets.ianbarton.net/"
BLOG_EMAIL = "ian@manor-farm.org"
BLOG_DESCRIPTION = "Various Snippets of Code."  # (translatable)
...
BODY_END = """
   ...
   <script async src="https://www.googletagmanager.com/gtag/js?id=UA-46799003-1"></script>
   <script>
     window.dataLayer = window.dataLayer || [];
     function gtag(){dataLayer.push(arguments);}
     gtag('js', new Date());

     gtag('config', 'UA-46799003-1');
   </script>
"""
